    ...
    return (
      <div className={styles.container}>
        ...
        <div className={styles.imgContainer}>
          <img src={libertyFallsBanner} alt={placeholderLogo} onClick={() => handleRedirect("/zombies/liberty-falls")}/>
          <img src={terminusBanner} alt={placeholderLogo} onClick={() => handleRedirect("/zombies/terminus")}/>
        </div>
      </div>
    )
  }
